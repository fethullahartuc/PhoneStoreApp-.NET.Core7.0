namespace StoreApp.Models
{
    public class Repository
    {
        ...
        static Repository()
        {
            ...
            _products.Add(new Product { ProductId = 6, Name = "Macbook Air Pro", Price = 90000, IsActive = true, Image = "6.jpg", CategoryId = 2 });
        }
        ...
        {
            var entity = _products.FirstOrDefault(w => w.ProductId == updatedProduct.ProductId);
            if (entity != null)
            {
        ...
        {
            var entity = _products.FirstOrDefault(w => w.ProductId == deletedProduct.ProductId);
            if (entity != null)
